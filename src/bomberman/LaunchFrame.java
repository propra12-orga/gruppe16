...
public class LaunchFrame {
	...
	/**
	 * Load-Frame erzeugen und anzeigen
	 * @param la Objekt
	 */
	public void load_malen(LaunchFrame la){
		// wie normales malen, nur ohne bombi und bomba extra zu setzen.
		 lf = la;
	     ...
	     lf.frame.add(lb.panel);
	     lf.frame.validate();
	     System.out.println("load gezeichnet");
