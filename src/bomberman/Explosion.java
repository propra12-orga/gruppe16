...
class Explosion extends TimerTask {
	...
	lf.block[lf.bombex+1][lf.bombey].setIcon(lf.explo);
	lf.exploaktiv[lf.bombex+1][lf.bombey]=true;
	k.killplayer(lf,lf.bombex+1,lf.bombey);
	...
	if(lf.bombex+2<lf.block.length && lf.block[lf.bombex+1][lf.bombey].destroyable==true && lf.block[lf.bombex+2][lf.bombey].destroyable==true) { //bombe 2unten
		lf.block[lf.bombex+2][lf.bombey].setIcon(lf.explo);
		lf.exploaktiv[lf.bombex+2][lf.bombey]=true;
		k.killplayer(lf,lf.bombex+2,lf.bombey);
	...
	if(lf.block[lf.bombex][lf.bombey+1].destroyable==true) { //bombe 1rechts
		lf.block[lf.bombex][lf.bombey+1].setIcon(lf.explo);
		lf.exploaktiv[lf.bombex][lf.bombey+1]=true;
		k.killplayer(lf,lf.bombex,lf.bombey+1);
	...
	if(lf.bombey+2<lf.block.length && lf.block[lf.bombex][lf.bombey+1].destroyable==true && lf.block[lf.bombex][lf.bombey+2].destroyable==true) { //bombe 2rechts
		lf.block[lf.bombex][lf.bombey+2].setIcon(lf.explo);
		lf.exploaktiv[lf.bombex][lf.bombey+2]=true;
		k.killplayer(lf,lf.bombex,lf.bombey+2);
	...
	lf.timer.schedule(new Loeschen(lf.bombex,lf.bombey,lf), 1000);  //bombe selber
	}
}
