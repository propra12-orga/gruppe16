...
public class Vorabfragen {
    ...
    */
	...
	public void fragen(LaunchFrame la) {
	    ...
	    new_dialog.setLayout(new GridLayout(13,1));        
		...
		JLabel saveinfo = new JLabel(" Während des Spiels speichert 'o' den Spielstand, 'p' lädt ihn ");
		//if(bu.)
		new_dialog.add(sf1);
        new_dialog.add(sf2);
        ...
        new_dialog.add(mu1);
        new_dialog.add(jsep3);
        new_dialog.add(saveinfo);
        new_dialog.add(save);
